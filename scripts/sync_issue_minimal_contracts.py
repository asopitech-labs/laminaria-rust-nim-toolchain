...
CONTRACTS: dict[int, Contract] = {
    ...
    31: Contract("P0", "Rust/Nim境界を跨いで保持したsemantic factsにより、separate compilationでは困難なowned変換と狭い再利用を成立させられる。", "Rust caller/Nim calleeまたは逆方向の一例をowned IRで合成し、変換ON/OFFと意味変更／非意味変更を比較する。", "cross-language変換の合法性とinvalidation境界を一つ採用または棄却できた時点。"),
