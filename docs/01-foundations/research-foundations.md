...
[Current self-build](../04-guides/self-build.md) documents the implemented external-compiler driver baseline. Its generation protocol is useful bootstrap evidence, not independent compiler self-hosting.
