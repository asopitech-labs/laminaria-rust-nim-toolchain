...
訂正の基準は[独自コンパイラの責務契約](../01-foundations/compiler-ownership-contract_ja.md)（[English](../01-foundations/compiler-ownership-contract.md)）。独自compiler/IRの形やpass構成をここで既定にはせず、**誰が意味解析・変換・生成・計算scheduleを担うか**を明確にした。
...
| [docs/02-research-areas/toolchains/agent-oriented-toolchain-ux.md](../02-research-areas/toolchains/agent-oriented-toolchain-ux.md) | 独自compiler profileの条件を追加。既存tool行列は比較/bootstrapへ限定 |
| [docs/02-research-areas/toolchains/agent-oriented-toolchain-ux_ja.md](../02-research-areas/toolchains/agent-oriented-toolchain-ux_ja.md) | 独自compiler profileの条件を追加。既存tool行列は比較/bootstrapへ限定 |
| [docs/02-research-areas/compiler/backend-pipeline-whiteboxing.md](../02-research-areas/compiler/backend-pipeline-whiteboxing.md) | 既存backend/link実験と独自compiler責務を分離 |
| [docs/02-research-areas/compiler/backend-pipeline-whiteboxing_ja.md](../02-research-areas/compiler/backend-pipeline-whiteboxing_ja.md) | 既存backend/link実験と独自compiler責務を分離 |
| [docs/02-research-areas/execution/horizontal-distribution-research.md](../02-research-areas/execution/horizontal-distribution-research.md) | 垂直統合・水平分散・永続化・異種nodeの研究を維持し、独自compiler計算を明示 |
| [docs/02-research-areas/execution/horizontal-distribution-research_ja.md](../02-research-areas/execution/horizontal-distribution-research_ja.md) | 垂直統合・水平分散・永続化・異種nodeの研究を維持し、独自compiler計算を明示 |
| [docs/03-work-items/issue-plan.md](../03-work-items/issue-plan.md) | #25/#3/#6/#8を中核に依存順序を訂正 |
| [docs/02-research-areas/compiler/llvm-rediscovery-research.md](../02-research-areas/compiler/llvm-rediscovery-research.md) | 本経路の責務を明示。目的・主経路・完了条件を訂正 |
| [docs/02-research-areas/compiler/llvm-rediscovery-research_ja.md](../02-research-areas/compiler/llvm-rediscovery-research_ja.md) | 本経路の責務を明示。目的・主経路・完了条件を訂正 |
| [docs/02-research-areas/measurement/measurement-foundation.md](../02-research-areas/measurement/measurement-foundation.md) | 独自in-process計算の証拠と外部process計測を区別 |
| [docs/02-research-areas/measurement/measurement-foundation_ja.md](../02-research-areas/measurement/measurement-foundation_ja.md) | 独自in-process計算の証拠と外部process計測を区別 |
| [docs/01-foundations/metrics-policy.md](../01-foundations/metrics-policy.md) | 独自in-process計算の証拠と外部process計測を区別 |
| [docs/02-research-areas/toolchains/multi-version-toolchains.md](../02-research-areas/toolchains/multi-version-toolchains.md) | 独自compiler profileの条件を追加。既存tool行列は比較/bootstrapへ限定 |
| [docs/02-research-areas/toolchains/multi-version-toolchains_ja.md](../02-research-areas/toolchains/multi-version-toolchains_ja.md) | 独自compiler profileの条件を追加。既存tool行列は比較/bootstrapへ限定 |
| [docs/04-guides/project-build.md](../04-guides/project-build.md) | 外部委譲baselineの実装記録へ訂正。コマンド挙動は変更しない |
| [docs/04-guides/project-build_ja.md](../04-guides/project-build_ja.md) | 外部委譲baselineの実装記録へ訂正。コマンド挙動は変更しない |
| [docs/01-foundations/project-proposal.md](../01-foundations/project-proposal.md) | 本経路の責務を明示。目的・主経路・完了条件を訂正 |
| [docs/01-foundations/project-proposal_ja.md](../01-foundations/project-proposal_ja.md) | 本経路の責務を明示。目的・主経路・完了条件を訂正 |
| [docs/01-foundations/research-foundations.md](../01-foundations/research-foundations.md) | 本経路の責務を明示。目的・主経路・完了条件を訂正 |
| [docs/01-foundations/research-foundations_ja.md](../01-foundations/research-foundations_ja.md) | 本経路の責務を明示。目的・主経路・完了条件を訂正 |
| [docs/01-foundations/research-program.md](../01-foundations/research-program.md) | 本経路の責務を明示。目的・主経路・完了条件を訂正 |
| [docs/01-foundations/research-program_ja.md](../01-foundations/research-program_ja.md) | 本経路の責務を明示。目的・主経路・完了条件を訂正 |
| [docs/02-research-areas/compiler/rust-nim-native-linking.md](../02-research-areas/compiler/rust-nim-native-linking.md) | 既存backend/link実験と独自compiler責務を分離 |
| [docs/02-research-areas/compiler/rust-nim-native-linking_ja.md](../02-research-areas/compiler/rust-nim-native-linking_ja.md) | 既存backend/link実験と独自compiler責務を分離 |
| [docs/04-guides/self-build.md](../04-guides/self-build.md) | 外部委譲baselineの実装記録へ訂正。コマンド挙動は変更しない |
| [docs/04-guides/self-build_ja.md](../04-guides/self-build_ja.md) | 外部委譲baselineの実装記録へ訂正。コマンド挙動は変更しない |
| [docs/02-research-areas/toolchains/toolchain-ux-research-contract.md](../02-research-areas/toolchains/toolchain-ux-research-contract.md) | 独自compiler profileの条件を追加。既存tool行列は比較/bootstrapへ限定 |
| [docs/02-research-areas/toolchains/toolchain-ux-research-contract_ja.md](../02-research-areas/toolchains/toolchain-ux-research-contract_ja.md) | 独自compiler profileの条件を追加。既存tool行列は比較/bootstrapへ限定 |
| [docs/02-research-areas/toolchains/validated-toolchain-profiles.md](../02-research-areas/toolchains/validated-toolchain-profiles.md) | 独自compiler profileの条件を追加。既存tool行列は比較/bootstrapへ限定 |
| [docs/02-research-areas/toolchains/validated-toolchain-profiles_ja.md](../02-research-areas/toolchains/validated-toolchain-profiles_ja.md) | 独自compiler profileの条件を追加。既存tool行列は比較/bootstrapへ限定 |
