...
複数compiler versionの扱いは `docs/02-research-areas/toolchains/multi-version-toolchains_ja.md` をcanonical policyとし、#18/#22で実装・検証する。
...
詳細は `docs/02-research-areas/toolchains/multi-version-toolchains_ja.md` を参照する。
