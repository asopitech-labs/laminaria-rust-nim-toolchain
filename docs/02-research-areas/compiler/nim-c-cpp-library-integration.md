...
This document is governed by the [compiler ownership contract](../../01-foundations/compiler-ownership-contract.md). It distinguishes legitimate foreign-library compilation and linking from delegating Nim target compilation to Nim-generated C/C++.
