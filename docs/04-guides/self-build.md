...
`docs/01-foundations/project-proposal.md` section 7/11 names four reference projects
...
For that, see `docs/04-guides/project-build.md` (issue #26): `laminaria build`/
